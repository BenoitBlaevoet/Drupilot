...
namespace Drupal\Tests\drupal_mcp_field_group\Kernel;

use Drupal\Core\Entity\Entity\EntityFormDisplay;
use Drupal\Core\Entity\Entity\EntityViewDisplay;
use Drupal\KernelTests\KernelTestBase;
use Drupal\drupal_mcp_field_group\Plugin\McpTool\FieldGroup\CreateFieldGroupTool;
use Drupal\drupal_mcp_field_group\Plugin\McpTool\FieldGroup\DeleteFieldGroupTool;
use Drupal\drupal_mcp_field_group\Plugin\McpTool\FieldGroup\ListFieldGroupsTool;
use Drupal\node\Entity\NodeType;
...
final class FieldGroupToolsKernelTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    /** @var \Drupal\drupal_mcp_field_group\Plugin\McpTool\FieldGroup\CreateFieldGroupTool $createTool */
    $createTool = $this->container->get('drupal_mcp_field_group.tool.field_group_create');
    $this->createTool = $createTool;

    /** @var \Drupal\drupal_mcp_field_group\Plugin\McpTool\FieldGroup\DeleteFieldGroupTool $deleteTool */
    $deleteTool = $this->container->get('drupal_mcp_field_group.tool.field_group_delete');
    $this->deleteTool = $deleteTool;

    /** @var \Drupal\drupal_mcp_field_group\Plugin\McpTool\FieldGroup\ListFieldGroupsTool $listTool */
    $listTool = $this->container->get('drupal_mcp_field_group.tool.field_group_list');
  ...
  public function testCreateToolIsRegisteredInContainer(): void {
    ...
    $this->assertInstanceOf(
      ...
      $this->container->get('drupal_mcp_field_group.tool.field_group_create'),
    );
  }
