...
namespace Drupal\Tests\drupilot_layout_paragraphs\Kernel;

use Drupal\Core\Entity\Entity\EntityFormDisplay;
use Drupal\Core\Entity\Entity\EntityViewDisplay;
use Drupal\KernelTests\KernelTestBase;
use Drupal\paragraphs\ParagraphsTypeInterface;
use Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Field\ConfigureLayoutParagraphsDisplayTool;
use Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Layout\ListLayoutsTool;
use Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Paragraph\ConfigureParagraphTypeLayoutTool;
...
final class LayoutParagraphsToolsKernelTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    /** @var \Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Layout\ListLayoutsTool $layoutListTool */
    $layoutListTool = $this->container->get('drupilot_layout_paragraphs.tool.layout_list');
    $this->layoutListTool = $layoutListTool;

    /** @var \Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Paragraph\ConfigureParagraphTypeLayoutTool $configureLayoutTool */
    $configureLayoutTool = $this->container->get('drupilot_layout_paragraphs.tool.paragraph_type_configure_layout');
    $this->configureLayoutTool = $configureLayoutTool;

    /** @var \Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Field\ConfigureLayoutParagraphsDisplayTool $configureDisplayTool */
    $configureDisplayTool = $this->container->get('drupilot_layout_paragraphs.tool.paragraph_field_configure_layout_display');
  ...
  public function testConfigureParagraphTypeLayout(): void {
    ...
    /** @var \Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\CreateParagraphTypeTool $createTool */
    $createTool = $this->container->get('drupilot_paragraphs.tool.paragraph_type_create');
  ...
  public function testAllToolsAreRegisteredInContainer(): void {
    ...
    $this->assertInstanceOf(
      ...
      $this->container->get('drupilot_layout_paragraphs.tool.layout_list'),
    );
    // @phpstan-ignore method.alreadyNarrowedType
    $this->assertInstanceOf(
      ConfigureParagraphTypeLayoutTool::class,
      $this->container->get('drupilot_layout_paragraphs.tool.paragraph_type_configure_layout'),
    );
    // @phpstan-ignore method.alreadyNarrowedType
    $this->assertInstanceOf(
      ConfigureLayoutParagraphsDisplayTool::class,
      $this->container->get('drupilot_layout_paragraphs.tool.paragraph_field_configure_layout_display'),
    );
  }
