...
namespace Drupal\Tests\drupilot_layout_paragraphs\Unit\Plugin\McpTool\Field;
...
final class ConfigureLayoutParagraphsDisplayToolTest extends UnitTestCase {
   ...
   *
   * @return \Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Field\ConfigureLayoutParagraphsDisplayTool
   *   The tool under test.
   */
