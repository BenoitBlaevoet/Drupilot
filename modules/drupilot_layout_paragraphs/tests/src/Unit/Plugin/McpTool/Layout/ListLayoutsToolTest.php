...
namespace Drupal\Tests\drupilot_layout_paragraphs\Unit\Plugin\McpTool\Layout;
...
final class ListLayoutsToolTest extends UnitTestCase {
   ...
   *
   * @return \Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Layout\ListLayoutsTool
   *   The tool under test.
   */
