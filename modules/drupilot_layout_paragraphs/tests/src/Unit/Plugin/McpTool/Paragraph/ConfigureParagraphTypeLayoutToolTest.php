...
namespace Drupal\Tests\drupilot_layout_paragraphs\Unit\Plugin\McpTool\Paragraph;
...
final class ConfigureParagraphTypeLayoutToolTest extends UnitTestCase {
   ...
   *
   * @return \Drupal\drupilot_layout_paragraphs\Plugin\McpTool\Paragraph\ConfigureParagraphTypeLayoutTool
   *   The tool under test.
   */
