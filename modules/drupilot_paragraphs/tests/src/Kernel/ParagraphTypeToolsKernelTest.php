...
namespace Drupal\Tests\drupilot_paragraphs\Kernel;

use Drupal\KernelTests\KernelTestBase;
use Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\CreateParagraphTypeTool;
use Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\DeleteParagraphTypeTool;
use Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\ListParagraphTypesTool;
use Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\UpdateParagraphTypeTool;
...
final class ParagraphTypeToolsKernelTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    /** @var \Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\UpdateParagraphTypeTool $updateTool */
    $updateTool = $this->container->get('drupilot_paragraphs.tool.paragraph_type_update');
    $this->updateTool = $updateTool;

    /** @var \Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\DeleteParagraphTypeTool $deleteTool */
    $deleteTool = $this->container->get('drupilot_paragraphs.tool.paragraph_type_delete');
    $this->deleteTool = $deleteTool;

    /** @var \Drupal\drupilot_paragraphs\Plugin\McpTool\Paragraph\ListParagraphTypesTool $listTool */
    $listTool = $this->container->get('drupilot_paragraphs.tool.paragraph_type_list');
  ...
  public function testCreateToolIsRegisteredInContainer(): void {
    ...
    $this->assertInstanceOf(
      ...
      $this->container->get('drupilot_paragraphs.tool.paragraph_type_create'),
    );
  }
