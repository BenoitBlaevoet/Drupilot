...
/**
 * Deletes an existing paragraph type.
 */
#[McpTool(
  id: 'paragraph_type_delete',
  label: 'Delete paragraph type',
  description: 'Deletes an existing Drupal paragraph type and all its fields.',
  category: 'paragraph_type',
)]
final class DeleteParagraphTypeTool implements McpToolInterface {
  ...
  public function getInputSchema(): array {
    return [
      ...
      'properties' => [
        'machine_name' => [
          'type' => 'string',
          'description' => 'Machine name of the paragraph type to delete.',
        ],
      ],
  ...
  public function execute(array $input): McpResponse {
    try {
      ...
      $this->logger->info('MCP: Deleted paragraph type @machine_name.', ['@machine_name' => $machineName]);

      return McpResponse::success(NULL, ['machine_name' => $machineName, 'deleted' => TRUE]);
    }
    catch (EntityStorageException $e) {
      Error::logException($this->logger, $e);
      return McpResponse::error(NULL, McpError::INTERNAL_ERROR, 'Failed to delete paragraph type.');
    }
    catch (\Throwable $e) {
      Error::logException($this->logger, $e);
